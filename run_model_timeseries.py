...
def evaluate(model,
    ...
    with torch.no_grad():
        ...
        for batch in test:
            ...
            fn = batch['fn']
            img_high = batch['90_pct']
            img_low = batch['low']
            image_fn_path = batch['fn_img_path']
            affine = batch['affine'], batch['pad_amnt'], batch['subj_name']
...
def main(args,
    ...
    data = DataLoaderInference(data_path,
                               subj_folds,
                               img_dir_name,
                               label_dir_name,
                               pad_factor=pad_factor,
...
if __name__ == '__main__':
    ...
    # ======================
    dir_list = util.listdir_nohidden_sort_numerical(args.data_path,
                                                    list_dir = True,
                                                    sort_digit = True)
